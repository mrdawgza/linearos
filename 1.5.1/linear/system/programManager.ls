...
local function programManager()
 if fs.exists("linear/userFolders/"..user.getCurrent().."/programs/") then
        local function uninstall()
                ...
                local ProgramFolder = "linear/userFolders/"..user.getCurrent().."/programs/"
        ...
        local function install()
                ...
                if pid == "cancel" then
                        ...
                        if shell.run("pastebin get "..pid.. "linear/userFolders/"..user.getCurrent().."/programs/"..ito) then
                                print("Successful!")
                                sleep(2)
                                programManager()
                        else
  ...
  fs.makeDir("linear/userFolders/"..user.getCurrent().."/programs/")
  programManager()
end
end
