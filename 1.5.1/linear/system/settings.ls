...
local function settingsProgram()
 ...
 local function aboutLinear()
  drawScreen()
  drawBar("About LinearOS","back")
  pos(1,3)
  ...
  local freeSpace2 = freeSpace1 / "1000"
  print("Free Disk Space: "..freeSpace2.."kb")
  while true do
  local event, button, x, y = os.pullEventRaw()
  if event == "mouse_click" then
